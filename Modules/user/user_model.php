...
class User
{
    ...
    public function register($username, $password, $email)
    {
        ...
        if (preg_replace('/[^\p{N}\p{L}\-\_\.]/u', '', $username) != $username) return array('success'=>false, 'message'=>_("Username must only contain A-z a-z 0-9 - _ . characters"));
    ...
    public function send_verification_email($username)
    {
        ...
        if (preg_replace('/[^\p{N}\p{L}\-\_\.]/u', '', $username) != $username) return array('success'=>false, 'message'=>_("Invalid username"));
    ...
    public function login($username, $password, $remembermecheck, $referrer='')
    {
        ...
        $username_out = preg_replace('/[^\p{N}\p{L}\-\_\.]/u', '', $username);
